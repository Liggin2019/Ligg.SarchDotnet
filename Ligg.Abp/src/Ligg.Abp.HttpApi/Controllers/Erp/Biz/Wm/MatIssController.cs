...
{
    [ApiController]
    [Route(Grouping.GroupName_erp_biz_wm + "/[controller]")]
    [ApiExplorerSettings(GroupName = Grouping.GroupName_erp_biz_wm)]
    public class MatIssController : AbpController
    {
        public MatIssController()
        {
        }
