...
{
    [ApiController]
    [Route(Grouping.GroupName_erp_biz_pm + "/[controller]")]
    [ApiExplorerSettings(GroupName = Grouping.GroupName_erp_biz_pm)]
    public class VndMtnController : AbpController
    {
        public VndMtnController()
        {
        }
